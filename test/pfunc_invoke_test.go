...
func TestInvokeWithOutReturn(t *testing.T) {
	result := pfunc.Invoke("dirs/a/b/c/pfunc_test.py", "func1", nil)
...
func TestInvokeWithStringReturn(t *testing.T) {
	result := pfunc.Invoke("dirs/a/b/c/pfunc_test.py", "func3", []interface{}{
...
func TestInvokeWithException(t *testing.T) {
	result := pfunc.Invoke("dirs/a/b/c/pfunc_test.py", "func4", []interface{}{2, 0})
	fmt.Println(result.Inspect())
...
func TestInvokeWithFloatReturn(t *testing.T) {
	result := pfunc.Invoke("dirs/a/b/c/pfunc_test.py", "func5", []interface{}{3.0, 2.0})
	fmt.Println(result.Inspect())
	assert.Equal(t, true, result.NoError)
